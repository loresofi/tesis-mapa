...
<div id="page-map" class="page active">
  ...
  <div id="filterPanel">
    ...
    <div class="chk-row"><input type="checkbox" id="fDRX"><label for="fDRX">Solo con análisis DRX</label></div>
    <div class="chk-row"><input type="checkbox" id="fGeo"><label for="fGeo">Solo con análisis geoquímico</label></div>
    <div class="chk-row"><input type="checkbox" id="fPetro"><label for="fPetro">Solo análisis petrográfico</label></div>
...
function renderDesc(code, s){
  ...
  let html=``;
  if(obs) html+=`<div class="desc-section"><h4>Descripción petrográfica</h4>
    <div class="description-box">${esc(obs)}</div></div>`;
  if(d&&d.descripcion){
  ...
  if(!html) html=`<div class="no-drx">Sin descripción disponible para esta muestra.</div>`;
  body.innerHTML=html;
}
